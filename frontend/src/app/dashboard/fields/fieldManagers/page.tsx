...
const FieldManagerAdminPage = () => {
  ...
  const managers = [
    { 
      id: 1,
      name: "John Doe",
      email: "john@minifootball.com",
      phone: "+1 234 567 890",
      field: "Field 1 - Downtown",
      status: "active",
    ...
    { 
      id: 2,
      name: "Sarah Smith",
      email: "sarah@minifootball.com",
      phone: "+1 987 654 321",
      field: "Field 2 - Riverside",
      status: "inactive",
                ...
                <AnimatePresence>
                  {managers.map((manager) => (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">ID: {manager.id}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{manager.field}</td>
                      <td className="px-6 py-4">
