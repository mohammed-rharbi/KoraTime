  ...
  const handleImagePick = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      try {
        ...
        setFormData(prev => ({ ...prev, photo: 'https://i.pinimg.com/736x/70/8c/08/708c08614099f90b849c6f7089f8effb.jpg' }));
      } finally {
        setUploading(false);
      }
    }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8 dark:from-gray-900 dark:to-gray-800">
        ...
        >
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Set up your football field with detailed specifications
          </p>
        </motion.div>
